...
def dice():
   ...
   print("            ↪️ \033[1;36m Settingan Awal Anda ["+res+setbetset["Name Bet Set"]+"\033[1;36m]")
   ...
   try:
       while True:
           ...
           if autobetset == "on":
               if (int(obj["Auto Change Betset"]["Interval"])) !=0:
                   ...
                   if int(waktu) > int(menit-1):
                       ...
                       print("         🔄 \033[1;36m Ganti Settingan Ke ["+res+setbetset["Name Bet Set"]+"\033[1;36m]")
           ...
           if prof > 0:
               ...
               if rcc == "on":
                   print (cekhilo(win, hilo)+'\x1b[0m'+"|"+resultbet(win,str(rev(str(basebet))))+"|","Prof",hijau2+str(str(wd2))+"|","BaL",kun+str(rev(str(finalbal)))+"|"+blue2+"Total"+": "+ str(str(wd)))
               else:
                   print (cekhilo(win, hilo)+'\x1b[0m'+"|"+resultbet(win,str(rev(str(basebet))))+"|","Prof",hijau2+str(str(wd2))+"|","BaL",kun+str(rev(str(finalbal)))+"|"+blue2+"Total" +": "+ str(str(wd)))
           else:
    
               if rcc == "on":
                   print (cekhilo(win, hilo)+'\x1b[0m'+"|"+resultbet(win,str(rev(str(basebet))))+"|"," Lose",red2+"-"+str(str(wd2))+"|","BaL",kun+str(rev(str(finalbal)))+"|"+blue2+"Total"+ ": "+ str(str(wd)))
               else:
                   print (cekhilo(win, hilo)+'\x1b[0m'+"|"+resultbet(win,str(rev(str(basebet))))+"|"," Lose",red2+"-"+str(str(wd2))+"|","BaL",kun+str(rev(str(finalbal)))+"|"+blue2+"Total"+ ": "+ str(str(wd)))
